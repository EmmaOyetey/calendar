...
//        int choice = inputHandler.nextInt();
//
//        if (choice < 1 || choice >= allCalendars.size()) {
//            commandLine.displayInvalidInputMessage();
//            return;
//        }
//
...
//
//    public FreeTimeSlotFinder(Calendar calendar, List<Calendar> allCalendars, CommandLine commandLine, InputHandler inputHandler) {
//        this.calendar = calendar;
//        this.allCalendars = allCalendars;
